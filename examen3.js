   let alumno = "";
    ...
    window.onload = function () {
      const resultadoGuardado = localStorage.getItem('examen3-estudiar-biblia');
    ...
    function desbloquearExamen() {
      ...
      if (clave === "59") {
        localStorage.removeItem('examen3-estudiar-biblia');
        location.reload();
      } else {
...
//   if (estudie) puntaje++;
  ...
  localStorage.setItem('examen3-estudiar-biblia', JSON.stringify({
    nombre: alumno,
    puntaje,
    porcentaje,
